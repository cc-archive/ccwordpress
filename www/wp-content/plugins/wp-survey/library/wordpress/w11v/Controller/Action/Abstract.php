<?php
abstract class w11v_Controller_Action_Abstract extends b11v_Controller_Action {
	...
	protected function setView() {
		$this->view = new w11v_View ( $this->application () );
	}
	...
	protected function subpages() {
		...
		foreach ( ( array ) $_GET as $key => $value ) {
			if (b11v_Type_String::staticStartsWith ( $key, 'page' )) {
				$pages [$key] = $value;
			}
		}
		ksort ( $pages );
