<?php
abstract class w11v_Controller_Action_Filter extends w11v_Controller_Action_Abstract {
	...
	public function plugin_action_linksAction($links, $file) {
		...
		if (! empty ( $options ['donate_link'] )) {
			$donate = '<a href="'.$this->application()->Settings()->donate_link.'" title = "Help support the development of this plugin">Donate</a>';
