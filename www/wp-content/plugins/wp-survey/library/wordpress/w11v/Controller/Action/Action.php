<?php
abstract class w11v_Controller_Action_Action extends w11v_Controller_Action_Abstract {
	...
	public function wp_headAction() {
		...
		if ($this->view->url !== false) {
			echo $this->renderScript ( 'Common/head.phtml' ) ;
		}
	}
	protected function url($file) {
		...
		if ($file !== false) {
			$return = w11v_Values::urlFromFileame ( $file );
		}
		return $return;
	}
