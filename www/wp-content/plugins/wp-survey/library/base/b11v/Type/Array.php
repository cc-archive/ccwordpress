<?php
class b11v_Type_Array extends b11v_Type_Abstract implements Iterator, ArrayAccess, Serializable, Countable {
	...
	private function convert() {
		foreach ( $this->value as $key => $value ) {
			if (is_array ( $value )) {
				$this->value [$key] = new b11v_Type_Array ( $this->application (), $value );
			}
		}
	}
	// iterator functions
