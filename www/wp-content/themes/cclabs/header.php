...
<html>
 <head>
  ...
  <link rel="alternate" type="application/rss+xml" title="RSS 2.0" href="<?php bloginfo('home')?>/feed">
  <? } else if (is_category()) { ?>
...
-->
        ...
        <span class="logo"><a href="<?php echo get_option('home'); ?>"><span><img src="<?php bloginfo('stylesheet_directory'); ?>/images/cc-labs.png" alt="creative commons" id="cc-title" border="0"/></span></a></span>
